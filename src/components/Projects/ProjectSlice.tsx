  ...
  return (
    <div {...stylex.props(styles.projectContainer)}>
      ...
      <div>
        ...
        >
          <h3>Slice the Pie</h3>
          <i {...stylex.props(styles.tagContainer)}>
            {["React", "Node.js", "HTML", "D3"].join(" ")}
          </i>
          <p>
            This project was created to provide users with an interactive way to
            compare their guesses of UC Davis administration expenditures with
            the actual data. It's an engaging tool that utilizes React and D3 to
            visualize financial information through dynamic pie charts.
          </p>
          <a href={href}>
